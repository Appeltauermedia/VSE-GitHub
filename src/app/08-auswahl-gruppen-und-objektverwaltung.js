...
function objectBBoxCss(o){
  ...
  if(o.type==='screen')return {x:x-su(o.screenWidth||260)/2,y:y-su(o.screenHeight||120)/2,w:su(o.screenWidth||260),h:su(o.screenHeight||120)};
...
function updateObjectManager(){
  ...
  const typeOrder=['light','lightbar','movinghead','fog','screen','waterSurface','waterFlowOverlay','mandalaVisualizer','imageAsset','audioSource','greenscreen','particle','visualizer','imageParticle'];
