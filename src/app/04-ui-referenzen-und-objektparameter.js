...
const bgFile=document.getElementById('bgFile'),bgColor=document.getElementById('bgColor'),bgMode=document.getElementById('bgMode'),bgOpacity=document.getElementById('bgOpacity'),bgZoom=document.getElementById('bgZoom'),bgPanX=document.getElementById('bgPanX'),bgPanY=document.getElementById('bgPanY');
...
function setBgCaptureButtonState(active){
  ...
  if(stageWrap)stageWrap.classList.toggle('workspaceCutting',!!active);
  if(typeof window.syncWorkspaceNavigationCursor==='function')window.syncWorkspaceNavigationCursor();
...
function particlePresetDefaults(mode){
  ...
  const map={
    ...
    pathFlow:{color:'#ff6a1a',particleAltColor:'#ffd45c',particleAltColor2:'#ff1f12',particleEmissionMode:'permanent',particleUnlimited:true,particleAmount:1.8,particleSpeed:1.3,particleSpread:24,particleLife:4.6,particleGravity:0,particleTurbulence:.32,particleSize:4.2,particleGlow:1.1,particleOpacity:.86,particleAudio:.25,particlePathShape:'line',particlePathWidth:360,particlePathHeight:180,particlePathArc:180,particlePathFlow:1,particlePathSpread:18,particlePathPoints:[]},
