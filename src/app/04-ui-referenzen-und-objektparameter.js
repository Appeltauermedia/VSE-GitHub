...
const bgToImageAssetBtn=document.getElementById('bgToImageAssetBtn'),bgToImageAssetStatus=document.getElementById('bgToImageAssetStatus'),bgCaptureShape=document.getElementById('bgCaptureShape'),bgCaptureRemoveFromBackground=document.getElementById('bgCaptureRemoveFromBackground'),bgCaptureCreateAssetBtn=document.getElementById('bgCaptureCreateAssetBtn'),waterShapeInput=document.getElementById('pWaterShape');
...
const greenscreenVideoFile=document.getElementById('pGreenscreenVideoFile'),greenscreenWebcamBtn=document.getElementById('pGreenscreenWebcamBtn'),greenscreenStopBtn=document.getElementById('pGreenscreenStopBtn'),greenscreenInfo=document.getElementById('greenscreenInfo');
