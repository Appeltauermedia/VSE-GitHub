...
(function(){
  ...
  function screenTimelineEventFor(object){return object&&object.type==='screen'?(timelineState.events||[]).find(event=>event&&event.timelineAssetKind==='screen-media'&&timelineEventTargetId(event)===object.id):null;}
