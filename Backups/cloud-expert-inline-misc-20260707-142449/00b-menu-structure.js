(function(){
  ...
  function structureObjectMenu(){
    ...
    ['pIntensity','pScreenBrightness','pScreenOpacity','pScreenLedSimulation','pScreenScanlines','pImageAssetOpacity','pGreenscreenOpacity','pWaterOpacity','pVisualizerOpacity','pMandalaObjOpacity','pLife'].forEach(id=>moveField(appearance,id));
    ...
    moveButton(misc,'cloudExpertOpen');
    const cloudExpert=el('cloudExpertPanel');
    if(cloudExpert)moveNode(misc,cloudExpert);
